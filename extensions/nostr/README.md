...
Nostr DM channel plugin for OpenClawd using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to OpenClawd. It enables your bot to:
...
```bash
openclawd plugins install @openclawd/nostr
```
...
# Configure openclawd to use local relay
