...
- Version alignment with core OpenClawd release numbers.
...
- First public release of the @openclawd/voice-call plugin.
...
- CLI: `openclawd voicecall` commands (call/start/continue/speak/end/status/tail/expose).
