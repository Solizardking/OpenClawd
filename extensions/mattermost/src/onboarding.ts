import type { ChannelOnboardingAdapter, OpenClawdConfig, WizardPrompter } from "openclawd/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.openclawd.ai/channels/mattermost",
    ].join("\n"),
