...
export function listMattermostAccountIds(cfg: OpenClawdConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: OpenClawdConfig): string {
...
export function listEnabledMattermostAccounts(cfg: OpenClawdConfig): ResolvedMattermostAccount[] {
