...
function setMSTeamsDmPolicy(cfg: OpenClawdConfig, dmPolicy: DmPolicy) {
  const allowFrom =
    dmPolicy === "open"
...
function setMSTeamsAllowFrom(cfg: OpenClawdConfig, allowFrom: string[]): OpenClawdConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
