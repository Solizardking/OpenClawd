...
export function listZaloAccountIds(cfg: OpenClawdConfig): string[] {
...
export function resolveDefaultZaloAccountId(cfg: OpenClawdConfig): string {
...
function mergeZaloAccountConfig(cfg: OpenClawdConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: OpenClawdConfig): ResolvedZaloAccount[] {
