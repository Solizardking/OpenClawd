...
export function listZalouserAccountIds(cfg: OpenClawdConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: OpenClawdConfig): string {
...
function mergeZalouserAccountConfig(cfg: OpenClawdConfig, accountId: string): ZalouserAccountConfig {
