...
## Gemini Computer Use + Steel (Node.js)

If you want browser-control agents (CUA) with Gemini and Steel, use the ready starter in:

- `examples/steel-gemini-computer-use/`
...
npm install
cp .env.example .env
# set STEEL_API_KEY and GEMINI_API_KEY in .env
npm run dev
```
...
- runs a Gemini Computer Use action loop (`gemini-2.5-computer-use-preview`),
