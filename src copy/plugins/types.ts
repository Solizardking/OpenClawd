...
export interface OpenClawdPluginToolDefinition {
    ...
    execute: (
        ...
        ctx?: OpenClawdPluginToolContext,
    ) => Promise<OpenClawdPluginToolResult> | OpenClawdPluginToolResult;
}
...
export interface OpenClawdProviderAuthContext {
    ...
    prompter: {
        text: (opts: { message: string }) => Promise<string>;
...
export function emptyPluginConfigSchema(): OpenClawdPluginConfigSchema {
