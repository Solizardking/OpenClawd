...
- **Autonomous agent mode** - Dark Ralph thinks recursively and proactively
...
git clone https://github.com/darkralph/ralph-tui.git
cd ralph-tui
...
# Wallet commands
dark-ralph wallet --create   # Create new wallet
dark-ralph wallet --balance  # Show balance
dark-ralph wallet --address  # Show address
...
| `/prophecy` | Dark Ralph's predictions |
...
│   ├── engine/
│   │   └── ralph-agent.ts   # Autonomous agent engine
│   └── skills/
...
**Dark Ralph** - *Recursive. Autonomous. Infinite.*
