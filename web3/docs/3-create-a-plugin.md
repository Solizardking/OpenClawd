...
OpenClawd plugins enable your agent to interact with various blockchain protocols. 
...
## Manual Creation
### 1. Define your plugin extending the [PluginBase](https://github.com/openclawd/openclawd/tree/main/typescript/packages/core/src/classes/PluginBase.ts) class.

```typescript
import { PluginBase, WalletClientBase } from "@openclawdsolana/core";
...
```typescript
import { Tool } from "@openclawdsolana/core";
...
```typescript
import { PluginBase, WalletClientBase, createTool } from "@openclawdsolana/core";
...
- Open a PR to add it to the [plugins registry](https://github.com/openclawd/openclawd/tree/main/typescript/packages/plugins) in the [OpenClawd](https://github.com/openclawd/openclawd).
