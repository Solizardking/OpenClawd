 ...
 * 
 * This example demonstrates various ways to use the Jobs API through the OpenClawd API client.
 * The Jobs API provides a simplified request/response pattern for one-off agent interactions.
 */

import { OpenClawdClient, JobStatus } from '@openclawdsolana/api-client';

// Initialize the client
const client = OpenClawdClient.create({
    baseUrl: 'http://localhost:3000',
    apiKey: process.env.OPENCLAWD_SERVER_AUTH_TOKEN, // Optional
});
