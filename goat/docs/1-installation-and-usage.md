...
```bash
npm install @openclawdsolana/core
```

1. Depending on the type of wallet you want to use, install the corresponding wallet (see all wallets [here](https://github.com/openclawd/openclawd/tree/main#chains-and-wallets)):

```bash
npm install @openclawdsolana/wallet-solana
```

1. Install the plugins for the protocols you need (see all available plugins [here](https://github.com/openclawd/openclawd/tree/main#tools))

```bash
npm install @openclawdsolana/plugin-jupiter
```

4. Install the adapter for the agent framework you want to use (see all available adapters [here](https://github.com/openclawd/openclawd/tree/main#agent-frameworks))
