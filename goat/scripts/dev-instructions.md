# OpenClawd Developer Context

This file contains the core technical aspects of OpenClawd, focusing on its architecture, implementation, and developer-facing components. The codebase is organized as a monorepo with several key packages:

## Key Components

1. **Core Package**: The foundation of OpenClawd with the agent runtime, entity management, actions, and database interactions
