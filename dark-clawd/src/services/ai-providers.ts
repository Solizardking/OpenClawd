// ═══════════════════════════════════════════════════════════════════════════════
// DARK CLAWD TUI - AI Provider Services
...
export class GrokService {
  ...
  async analyzeMarket(context: string): Promise<AIResponse | null> {
    return this.chat([
      {
        role: 'system',
        content: `You are DARK CLAWD, a recursive autonomous AI analyzing cryptocurrency markets.
    ...
    try {
      const response = await fetch(`${this.baseUrl}/chat/completions`, {
        ...
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${this.apiKey}`,
          'HTTP-Referer': 'https://darkclawd.ai',
          'X-Title': 'Dark Clawd TUI',
        },
        body: JSON.stringify({
          model: this.model,
          messages,
  ...
  async analyzeWithReasoning(prompt: string, context = ''): Promise<AIResponse | null> {
    return this.chat(
      [
        {
          role: 'system',
          content: `You are DARK CLAWD, a recursive autonomous AI agent analyzing cryptocurrency markets.
