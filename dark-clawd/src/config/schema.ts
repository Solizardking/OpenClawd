...
// Dark Clawd Agent Config Schema
export const DarkClawdConfigSchema = z.object({
...
export const ConfigSchema = z.object({
  ...
  darkclawd: DarkClawdConfigSchema,
...
export type DarkClawdConfig = z.infer<typeof DarkClawdConfigSchema>;
...
export function loadConfigFromEnv(): Partial<Config> {
  return {
    ...
    darkclawd: {
      autoMode: process.env.DARK_CLAWD_AUTO_MODE === 'true',
      recursionDepth: parseInt(process.env.DARK_CLAWD_RECURSION_DEPTH || '5'),
      thoughtInterval: parseInt(process.env.DARK_CLAWD_THOUGHT_INTERVAL || '15000'),
      maxIterations: parseInt(process.env.DARK_CLAWD_MAX_ITERATIONS || '10'),
      personality: 'cryptic',
    },
