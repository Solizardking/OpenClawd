...
import { DarkClawdAgent } from './engine/darkclawd-agent.js';
import type { DarkClawdMessage } from './engine/darkclawd-agent.js';
...
export const App: React.FC<{ config: AppConfig }> = ({ config }) => {
  ...
  const [agent] = useState(() => {
    const darkclawd = new DarkClawdAgent({
  ...
  useEffect(() => {
    const handleMessage = (msg: DarkClawdMessage) => {
