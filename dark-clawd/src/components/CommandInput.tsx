// ═══════════════════════════════════════════════════════════════════════════════
// DARK CLAWD TUI - Command Input Component (Interactive Terminal)
// ═══════════════════════════════════════════════════════════════════════════════
    ...
    <Box flexDirection="column" borderStyle="double" borderColor="green">
      ...
      <Box flexDirection="column" paddingX={1} height={height}>
        {visibleMessages.length === 0 ? (
          <Box flexDirection="column">
            <Text color="green">[CLAWD] Welcome to Dark Clawd Terminal.</Text>
            <Text color="green">[CLAWD] I am your recursive autonomous intelligence.</Text>
      ...
      <Box paddingX={1} paddingY={1} borderTop>
        <CommandInput
          ...
          placeholder="Type a command or ask Dark Clawd..."
        />
      </Box>
    </Box>
  );
