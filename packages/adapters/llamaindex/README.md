...
# OpenClawd Adapter for Llamaindex
## Installation
```
npm install @openclawdsolana/adapter-llamaindex
yarn add @openclawdsolana/adapter-llamaindex
pnpm add @openclawdsolana/adapter-llamaindex
```
