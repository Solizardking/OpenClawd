...
This directory contains a comprehensive test suite for the OpenClawd Bootstrap Plugin. The tests cover all major components of the plugin including actions, providers, evaluators, services, and event handling logic.
