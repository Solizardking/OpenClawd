...
This document describes the process for publishing Python packages in the OpenClawd monorepo.
...
python scripts/version_bump.py --package openclawd --type patch

# Bump minor version for a specific package
python scripts/version_bump.py --package openclawd --type minor

# Bump major version for a specific package
python scripts/version_bump.py --package openclawd --type major
...
1. A PyPI account with publishing permissions for the OpenClawd packages
