# 1inch Plugin for OpenClawd

A plugin for the OpenClawd that provides 1inch DEX aggregator functionality.

## Installation

```bash
# Install the plugin
poetry add openclawd-plugin-1inch
...
```python
from openclawd_plugins.inch1 import inch1, Inch1PluginOptions
