# deBridge Plugin for OpenClawd

A plugin for the OpenClawd that provides access to deBridge Liquidity Network (DLN) functionality.

## Installation

```bash
# Install the plugin
poetry add openclawd-plugin-debridge
...
```python
from openclawd_plugins.debridge import debridge, DebridgePluginOptions
