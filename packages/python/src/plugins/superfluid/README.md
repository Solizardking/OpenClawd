# Superfluid Plugin for OpenClawd

A plugin for the OpenClawd that provides real-time token streaming and programmable cashflow functionality through the Superfluid Protocol.

## Installation

```bash
# Install the plugin
poetry add openclawd-plugin-superfluid
...
```python
from openclawd_plugins.superfluid import superfluid, SuperfluidPluginOptions
