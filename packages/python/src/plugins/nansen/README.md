# Nansen Plugin for OpenClawd

A plugin for the OpenClawd that provides access to Nansen's on-chain analytics and data services across multiple blockchains.

## Installation

```bash
# Install the plugin
poetry add openclawd-plugin-nansen
...
```python
from openclawd_plugins.nansen import nansen, NansenPluginOptions
