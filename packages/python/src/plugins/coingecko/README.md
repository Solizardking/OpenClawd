# CoinGecko Plugin for OpenClawd

A plugin for the OpenClawd that provides comprehensive cryptocurrency market data, price feeds, and analytics through the CoinGecko API.

## Installation

```bash
# Install the plugin
poetry add openclawd-plugin-coingecko
...
```python
from openclawd_plugins.coingecko import coingecko, CoinGeckoPluginOptions
