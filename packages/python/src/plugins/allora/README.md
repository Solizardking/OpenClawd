# Allora Plugin for OpenClawd

A plugin for the OpenClawd that provides AI-powered blockchain analytics and predictive modeling capabilities through the Allora API.

## Installation

```bash
# Install the plugin
poetry add openclawd-plugin-allora
...
```python
from openclawd_plugins.allora import allora, AlloraPluginOptions
