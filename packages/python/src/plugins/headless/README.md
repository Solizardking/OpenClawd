# Crossmint Headless Checkout Plugin for OpenClawd

A plugin for the OpenClawd that enables seamless purchasing of Amazon items and other tokenized products using cryptocurrency through Crossmint's headless checkout API.

## Installation

```bash
# Install the plugin
poetry add openclawd-plugin-crossmint-headless-checkout
...
```python
from openclawd_plugins.crossmint_headless_checkout import crossmint_headless_checkout, CrossmintHeadlessCheckoutPluginOptions
