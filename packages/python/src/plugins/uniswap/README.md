# Uniswap Plugin for OpenClawd

A plugin for the OpenClawd that provides Uniswap DEX functionality for token swaps and liquidity operations.

## Installation

```bash
# Install the plugin
poetry add openclawd-plugin-uniswap

# Install required dependencies
poetry add openclawd-wallet-evm
poetry add openclawd-plugin-erc20
```

## Usage

```python
from openclawd_plugins.uniswap import uniswap, UniswapPluginOptions
