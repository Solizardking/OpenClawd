# DEXScreener Plugin for OpenClawd

A plugin for the OpenClawd that provides real-time DEX pair data, price feeds, and liquidity information across multiple blockchain networks through the DEXScreener API.

## Installation

```bash
# Install the plugin
poetry add openclawd-plugin-dexscreener
...
```python
from openclawd_plugins.dexscreener import dexscreener, DexscreenerPluginOptions
