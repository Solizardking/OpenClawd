...
This plugin enables openclawd-agents to  connect  , subscribe to, and interact with data streams available on the [DPSN Data Streams MarketPlace](https://streams.dpsn.org/).
...
```bash
# Install the plugin
poetry add openclawd-plugin-dpsn
...
```python
from openclawd_plugins.dpsn import dpsn,DpsnPluginOptions
