# OpenSea Plugin for OpenClawd

A plugin for the OpenClawd that provides OpenSea NFT marketplace functionality for querying NFT collections, sales, and metadata.

## Installation

```bash
# Install the plugin
poetry add openclawd-plugin-opensea
...
```python
from openclawd_plugins.opensea import opensea, OpenSeaPluginOptions
