# RugCheck Plugin for OpenClawd

A plugin for the OpenClawd that provides token security analysis and verification services through the RugCheck API.

## Installation

```bash
# Install the plugin
poetry add openclawd-plugin-rugcheck
...
```python
from openclawd_plugins.rugcheck import rugcheck, RugCheckPluginOptions
