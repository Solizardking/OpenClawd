# JSON-RPC Plugin for OpenClawd

A plugin for the OpenClawd that enables making JSON-RPC calls to any blockchain or protocol endpoint supporting the JSON-RPC 2.0 specification.

## Installation

```bash
# Install the plugin
poetry add openclawd-plugin-jsonrpc
...
```python
from openclawd_plugins.jsonrpc import jsonrpc, JSONRpcPluginOptions
