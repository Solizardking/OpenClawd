# Crossmint Wallet Implementation for OpenClawd

This package provides Crossmint wallet integration for the OpenClawd, supporting both EVM Smart Wallets and Solana Custodial Wallets.
...
```bash
poetry add openclawd-wallet-crossmint
```

## Usage

```python
from openclawd_wallets.crossmint import smart_wallet_factory, custodial_factory
