# Web3 Wallet for OpenClawd

A Python implementation of a Web3 wallet for the OpenClawd, providing enhanced Ethereum and EVM-compatible chain support through web3.py integration.

## Installation

```bash
poetry add openclawd-wallet-web3
...
```python
from openclawd_wallets.web3 import web3
from openclawd_wallets.evm import USDC, PEPE
