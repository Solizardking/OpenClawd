...
# CrewAI Adapter for OpenClawd

Integrate the more than +200 onchain tools of OpenClawd with [CrewAI](https://github.com/crewAIInc/crewAI), a framework for orchestrating role-playing, autonomous AI agents.

## Installation

```bash
poetry add openclawd-adapter-crewai
```

## Usage

See a full working example [here](https://github.com/openclawd/openclawd/tree/main/python/examples/by-framework/crewai).
...
# --- Import CrewAI and the OpenClawd Adapter ---
from crewai import Agent, Task, Crew, Process
from openclawd_adapters.crewai.adapter import get_crewai_tools

# --- Generate CrewAI Tools from OpenClawd ---
openclawd_crewai_tools = get_crewai_tools(
    wallet=wallet,
    plugins=[]
)

# --- Define CrewAI Agent using OpenClawd Tools ---
...
crypto_analyst = Agent(
  ...
  verbose=True,
  tools=openclawd_crewai_tools # Assign the generated tools
)
