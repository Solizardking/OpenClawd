...
poetry add openclawd-adapter-langchain
```

## Usage

See a full working example [here](https://github.com/openclawd/openclawd/tree/main/python/examples/by-framework/langchain).

```python
from openclawd_adapters.langchain.adapter import get_on_chain_tools
