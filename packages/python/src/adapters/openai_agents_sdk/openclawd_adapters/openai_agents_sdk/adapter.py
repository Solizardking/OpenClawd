...
from openclawd import ToolBase, WalletClientBase, get_tools

def get_on_chain_tools(wallet: WalletClientBase, plugins: List[Any]) -> List[FunctionTool]:
    """Create OpenAI Agents SDK tools from OpenClawd tools.
    ...
    Returns:
        List of OpenAI Agents SDK Tool instances configured with the OpenClawd tools
    """
    ...
    for t in tools:
        ...
        # Create a OpenAI Agents SDK Tool for each OpenClawd tool
        tool = FunctionTool(
            name=t.name,
