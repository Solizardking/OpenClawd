...
# AG2 Adapter for OpenClawd

Integrate the more than +200 onchain tools of OpenClawd with [AG2](https://github.com/ag2ai/ag2), the open-source AgentOS (formerly AutoGen).

## Installation
```
pip install openclawd-adapter-ag2
poetry add openclawd-adapter-ag2
```

## Usage

See a full working example [here](https://github.com/openclawd/openclawd/tree/main/python/examples/by-framework/ag2).

```python
from openclawd_adapters.ag2.adapter import register_tools
