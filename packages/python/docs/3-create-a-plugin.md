...
You can see all available plugins [here](https://github.com/openclawd/openclawd/tree/main#tools).
...
### 1. Define your plugin extending the [PluginBase](https://github.com/openclawd/openclawd/tree/main/python/src/openclawd_sdk/openclawd/classes/plugin_base.py) class.
...
-   Open a PR to add it to the [plugins registry](https://github.com/openclawd/openclawd/tree/main/python/src/plugins) in the [OpenClawd](https://github.com/openclawd/openclawd).
