...
This example demonstrates how to use OpenClawd to **consume data feeds available on** on [DPSN streams store](https://streams.dpsn.org/). This example uses Binance BTC/USDT price tracking data feed from the dpsn streams
