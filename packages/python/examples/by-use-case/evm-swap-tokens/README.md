...
This example demonstrates how to use OpenClawd to **swap ERC-20 tokens on [Uniswap](https://uniswap.org/)** on EVM networks. This example uses [Base](https://base.org) but you can implement it with any other EVM network by changing the chain and RPC URL.
...
## Using in production
In production, developers require advanced wallet setups that utilize [smart wallets](https://github.com/openclawd/openclawd/tree/main/typescript/examples/by-wallet/crossmint-smart-wallets), which allow them to:
