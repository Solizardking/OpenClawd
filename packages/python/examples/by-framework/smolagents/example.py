...
try:
    ...
    # Get Smolagents-compatible tools from OpenClawd adapter
    openclawd_smolagents_tools = get_smolagents_tools(wallet=wallet, plugins=[])
    if not openclawd_smolagents_tools:
        ...
        print(f"Successfully loaded {len(openclawd_smolagents_tools)} OpenClawd tools for Smolagents.")
