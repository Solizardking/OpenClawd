...
describe('Mr. TEE Character Configuration', () => {
  ...
  it('should include TEE specific plugins', () => {
    expect(character.plugins).toContain('@openclawdsolana/plugin-tee');
    expect(character.plugins).toContain('@openclawdsolana/plugin-sql');
    expect(character.plugins).toContain('@openclawdsolana/plugin-openai');
    expect(character.plugins).toContain('@openclawdsolana/plugin-discord');
