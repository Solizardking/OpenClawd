...
This directory contains end-to-end tests for the OpenClawd project TEE (Trusted Execution Environment) starter template.
...
E2E tests run in a real OpenClawd runtime environment, allowing you to test your TEE-enabled project's behavior as it would work in production. These tests include validation of TEE-specific functionality such as attestation, secure operations, and cryptographic features.
...
5. **Runtime Access**: Each test receives a real runtime instance with full access to:
   ...
   - All standard OpenClawd features
