#!/usr/bin/env bun
/**
 * Build script for @openclawdsolana/cli using standardized build utilities
 */
...
const run = createBuildRunner({
  packageName: '@openclawdsolana/cli',
  buildOptions: {
...
export const CLI_NAME = '@openclawdsolana/cli';
export const CLI_DESCRIPTION = 'OpenClawd CLI';
export default { version: '0.0.0', name: '@openclawdsolana/cli', description: 'OpenClawd CLI' };`;
