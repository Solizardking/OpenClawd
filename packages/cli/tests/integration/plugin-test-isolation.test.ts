...
`;
  ...
  it('should set OPENCLAWD_TESTING_PLUGIN environment variable for plugins', async () => {
    ...
    const pluginContent = `
console.log('OPENCLAWD_TESTING_PLUGIN:', process.env.OPENCLAWD_TESTING_PLUGIN);
