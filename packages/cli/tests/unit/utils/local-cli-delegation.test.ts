...
describe('Local CLI Delegation', () => {
  ...
  beforeEach(() => {
    ...
    delete process.env.OPENCLAWD_SKIP_LOCAL_CLI_DELEGATION;
  ...
  describe('Test Environment Detection', () => {
    ...
    it('should skip delegation when OPENCLAWD_TEST_MODE is true', async () => {
    ...
    it('should skip delegation when OPENCLAWD_SKIP_LOCAL_CLI_DELEGATION is true', async () => {
      process.env.OPENCLAWD_SKIP_LOCAL_CLI_DELEGATION = 'true';
      mockExistsSync.mockReturnValue(true);
  ...
  describe('Local CLI Detection', () => {
    it('should detect when running from local CLI', async () => {
      ...
      process.argv = ['bun', '/test/project/node_modules/@openclawdsolana/cli/dist/index.js', 'start'];
      mockExistsSync.mockReturnValue(true);
    ...
    it('should continue when no local CLI is found', async () => {
      process.argv = ['bun', '/usr/bin/openclawd', 'start'];
    ...
    it('should delegate when local CLI is found and not running from it', async () => {
      process.argv = ['bun', '/usr/bin/openclawd', 'start', '--port', '3000'];
      mockExistsSync.mockReturnValue(true);
      ...
      expect(mockLogger.info).toHaveBeenCalledWith('Using local @openclawdsolana/cli installation');
      expect(spawnSpy).toHaveBeenCalledWith(
        [
          process.execPath,
          '/test/project/node_modules/@openclawdsolana/cli/dist/index.js',
          'start',
          '--port',
          '3000',
        ],
  ...
  describe('Utility Functions', () => {
    ...
    it('getCliContext should return correct context information', () => {
      ...
      expect(context.localPath).toBe('/test/project/node_modules/@openclawdsolana/cli/dist/index.js');
      expect(context.currentPath).toBe('/test/project/node_modules/@openclawdsolana/cli/dist/index.js');
    });
    ...
    it('getCliContext should return correct context when not running from local CLI', () => {
      ...
      expect(context.currentPath).toBe('/usr/bin/openclawd');
    });
  });
