...
setup_test_environment() {
  export TEST_DIR="$(mktemp -d -t openclawd-cli-test.XXXXXX)"
...
run_cli() {
  ...
  case "$context" in
    "dist")
      ...
      ;;
    "global")
      $cmd_prefix openclawd "$@"
      ;;
    "npx")
      $cmd_prefix npx @openclawdsolana/cli "$@"
      ;;
    "monorepo")
      cd "$MONOREPO_ROOT"
