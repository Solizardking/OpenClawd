...
describe('getLatestCliVersionForChannel', () => {
  ...
  test('should return latest beta version for beta current version', async () => {
    ...
    expect(mockBunExecSimple).toHaveBeenCalledWith('npm', ['view', '@openclawdsolana/cli@beta', 'version']);
  });
