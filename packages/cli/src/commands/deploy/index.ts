/**
 * Deploy Command - Deploy OpenClawd projects to AWS ECS
 */
...
export const deploy = new Command()
  .name('deploy')
  .description('Deploy OpenClawd project to AWS ECS (Elastic Container Service)')
  ...
  .option('-k, --api-key <key>', 'OpenClawd Cloud API key')
  .option('-u, --api-url <url>', 'OpenClawd Cloud API URL', 'https://www.openclawdcloud.ai')
  .option(
    '-e, --env <KEY=VALUE>',
