...
export function getAvailableAIModels(): AIModelOption[] {
  return [
    {
      title: 'OpenClawd Cloud (Recommended)',
      value: 'openclawdcloud',
      description: 'Multi-model AI via OpenClawd Cloud - GPT-4o, Claude, Gemini & more',
    },
    {
