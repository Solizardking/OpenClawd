...
export async function createAgent(
  ...
  // Create agent character based on OpenClawd template
  ...
  console.info(`\nTo use this agent:`);
  console.info(`  1. Start OpenClawd server with this character:`);
  console.info(`     openclawd start --character ${agentFilePath}`);
  console.info(`\n  OR if a server is already running:`);
  console.info(`     openclawd agent start --path ${agentFilePath}`);
}
