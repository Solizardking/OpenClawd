...
export const agent = new Command().name('agent').description('Manage OpenClawd agents');
...
agent
  ...
  .addHelpText(
    ...
    `
Examples:
  $ openclawd agent start -n "Agent Name"     Start an existing agent by name
  $ openclawd agent start --path ./char.json  Start with a local character file
  $ openclawd agent start --remote-character https://example.com/char.json

To create a new agent:
  $ openclawd create --type agent my-agent-name   Create a new agent using OpenClawd template
