    ...
    const expectedCombinations = [
      {
        ...
        'run[0].input': 'List open issues for OpenClawd/openclawd',
      },
      {
        'character.llm.model': 'gpt-4-turbo',
        'run[0].input': 'Find current issues for the openclawd/openclawd repo',
      },
      {
        'character.llm.model': 'gpt-4-turbo',
        'run[0].input': "Show me what's open in the OpenClawd/openclawd GitHub.",
      },
      {
