...
export const phalaCliCommand = new Command('phala')
  ...
  .on('--help', () => {
    ...
    console.log('  $ openclawd tee phala help');
    console.log('  $ openclawd tee phala auth login <api-key>');
    console.log('  $ openclawd tee phala cvms list');
    console.log('  $ openclawd tee phala cvms create --name my-app --compose ./docker-compose.yml');
    console.log('');
