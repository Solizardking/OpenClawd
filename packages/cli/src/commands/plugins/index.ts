...
export const plugins = new Command()
  .name('plugins')
  .description('Manage OpenClawd plugins')
  .action(() => {
...
plugins
  ...
  .argument('<plugin>', 'plugin name (e.g., "abc", "plugin-abc", "openclawd/plugin-abc")')
...
plugins
  ...
  .argument('<plugin>', 'plugins name (e.g., "abc", "plugin-abc", "openclawd/plugin-abc")')
