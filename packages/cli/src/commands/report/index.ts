 ...
 * with the OpenClawd CLI system. The report command provides tools for analyzing
...
export const report = new Command('report')
  ...
  .addHelpText(
    ...
    `
Examples:
  $ openclawd report generate ./output/matrix-20231027-1000/
  $ openclawd report generate ./output/matrix-20231027-1000/ --output-path ./reports/latest.json
