...
OpenClawd provides a comprehensive testing structure for plugins:
...
- **Component Tests** (`__tests__/` directory):
  ...
  - Run with: `openclawd test component`

- **End-to-End Tests** (`__tests__/e2e/` directory):

  - Test the plugin within a full OpenClawd runtime
  - Validate complete user scenarios with a real agent
  - Run with: `openclawd test e2e`

- **Running All Tests**:
  - `openclawd test` runs both component and e2e tests
...
E2E tests run in a real OpenClawd runtime:
...
- **Real Runtime Environment**: Tests run with a fully initialized OpenClawd runtime
