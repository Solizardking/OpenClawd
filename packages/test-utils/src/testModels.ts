import type { IAgentRuntime, GenerateTextParams, TextEmbeddingParams } from '@openclawdsolana/core';
...
/**
 * Model handler wrapper that integrates with OpenClawd runtime
 */
