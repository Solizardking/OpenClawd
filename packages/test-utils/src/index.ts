/**
 * @fileoverview OpenClawd Testing Infrastructure
 *
 ...
 * ```typescript
 * import { createTestRuntime, runIntegrationTest } from '@openclawdsolana/core/test-utils';
 *
 ...
 * ```typescript
 * import { createMockRuntime, createMockMemory } from '@openclawdsolana/core/test-utils';
 *
