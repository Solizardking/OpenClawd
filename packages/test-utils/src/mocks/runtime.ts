 ...
 *
 * @deprecated Use real runtime testing instead: import { createTestRuntime } from '@openclawdsolana/core/test-utils'
 *
 * @example Legacy Mock Testing (Deprecated)
 * ```typescript
 * import { createMockRuntime } from '@openclawdsolana/core/test-utils';
 *
...
export function createMockRuntime(overrides: MockRuntimeOverrides = {}): IAgentRuntime {
  ...
  const baseRuntime: IAgentRuntime = {
    ...
    hasOpenClawd(): this is IAgentRuntime & { OpenClawd: any } {
      return false;
    },
