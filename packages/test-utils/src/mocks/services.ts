...
import type { Service } from '@openclawdsolana/core';
import { ServiceType, ServiceTypeName } from '@openclawdsolana/core';
/**
 ...
 * @example
 * ```typescript
 * import { createMockService } from '@openclawdsolana/core/test-utils';
