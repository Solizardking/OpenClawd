...
import type { Character, MessageExample, UUID } from '@openclawdsolana/core';
 ...
 * @example
 * ```typescript
 * import { createMockCharacter } from '@openclawdsolana/core/test-utils';
 *
 * const mockCharacter = createMockCharacter({
 *   name: 'CustomAgent',
 *   bio: ['A specialized test agent'],
 *   plugins: ['@openclawdsolana/plugin-test']
 * });
 * ```
 */
export function createMockCharacter(overrides: MockCharacterOverrides = {}): Character {
  const baseCharacter: Character = {
    ...
    bio: [
      ...
      'Supports all core OpenClawd features and plugin interactions',
    ...
    messageExamples: [
      ...
      [
        ...
        },
        {
          name: 'TestAgent',
          content: {
            text: 'I can assist with testing various OpenClawd features including actions, providers, services, and plugin functionality.',
          },
        },
      ],
    ],
    ...
    postExamples: [
      'Testing new OpenClawd features today - everything looking good!',
    ...
    knowledge: [
      'OpenClawd architecture and patterns',
    ...
    plugins: ['@openclawdsolana/plugin-sql', '@openclawdsolana/plugin-bootstrap'],
