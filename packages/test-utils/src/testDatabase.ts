import type { IDatabaseAdapter, UUID, Memory } from '@openclawdsolana/core';
        ...
        if (process.env.FORCE_MOCK_DB === 'true') {
          ...
          try {
            ...
            interface GlobalWithSqlPlugin {
              __OpenClawd_sqlPlugin?: {
                createDatabaseAdapter?: (config: unknown, agentId: UUID) => IDatabaseAdapter;
              };
            }
            const sqlPlugin = (globalThis as GlobalWithSqlPlugin).__OpenClawd_sqlPlugin;
