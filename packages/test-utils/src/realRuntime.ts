...
import type { Character, IAgentRuntime, Memory, Plugin, UUID } from '@openclawdsolana/core';
import { AgentRuntime, logger, stringToUuid } from '@openclawdsolana/core';
...
export class RuntimeTestHarness {
  ...
  /**
   * Loads a plugin by name from the OpenClawd ecosystem
