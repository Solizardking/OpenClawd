...
A minimal backend-only plugin template for OpenClawd. This template provides a clean starting point for creating simple plugins without frontend complexity.
...
- Only essential packages (`@openclawdsolana/core`, `zod`)
...
- E2E tests with OpenClawd test runner for integration testing
...
This template is part of the OpenClawd project.
