...
This directory contains end-to-end tests for the OpenClawd plugin quick starter template.
...
E2E tests run in a real OpenClawd runtime environment, allowing you to test your plugin's behavior as it would work in production. The quick starter template focuses on minimal, essential functionality to help you get started quickly.
...
3. **Test Discovery**: The OpenClawd test runner automatically finds and executes tests
...
- Verify the OpenClawd test runner is up to date
