import type { Plugin } from '@openclawdsolana/core';
import {
  type Action,
  type ActionResult,
...
export const starterPlugin: Plugin = {
  ...
  description: 'Quick backend-only plugin template for OpenClawd',
  config: {
  ...
  // dependencies: ['@openclawdsolana/plugin-knowledge'], <--- plugin dependencies go here (if requires another plugin)
};
