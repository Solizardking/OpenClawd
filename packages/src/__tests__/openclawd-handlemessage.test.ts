...
describe('OpenClawd.handleMessage', () => {
  ...
  const mockCharacter: Character = {
    ...
    name: 'TestAgent',
    username: 'testagent',
    bio: 'Test agent for unit testing OpenClawd.handleMessage() functionality',
    settings: {
      secrets: {},
  ...
  beforeEach(async () => {
    ...
    OpenClawd.registerAgent(mockRuntime);
  });
  ...
  describe('ASYNC Mode', () => {
    it('should return immediately with messageId when onResponse provided', async () => {
      ...
      const result = await OpenClawd.handleMessage(
        agentId,
        {
          entityId: '123e4567-e89b-12d3-a456-426614174005' as UUID,
          roomId: '123e4567-e89b-12d3-a456-426614174002' as UUID,
    ...
    it('should call onError if messageService.handleMessage fails', async () => {
      ...
      const runtime = OpenClawd.getAgent(agentId);
      if (runtime) {
  ...
  describe('Edge Cases', () => {
    ...
    it('should throw error if agent not found', async () => {
      ...
      await expect(
        OpenClawd.handleMessage(fakeAgentId, {
          entityId: '123e4567-e89b-12d3-a456-426614174005' as UUID,
          roomId: '123e4567-e89b-12d3-a456-426614174002' as UUID,
          content: {
            text: 'Test',
    ...
    it('should throw error if messageService is not initialized', async () => {
      ...
      await expect(
        OpenClawd.handleMessage(agentId, {
          entityId: '123e4567-e89b-12d3-a456-426614174005' as UUID,
          roomId: '123e4567-e89b-12d3-a456-426614174002' as UUID,
          content: {
            text: 'Test',
