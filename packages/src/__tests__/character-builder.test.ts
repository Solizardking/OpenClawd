...
describe('buildCharacterPlugins', () => {
  ...
  const PLUGINS = {
    SQL: '@openclawdsolana/plugin-sql',
    BOOTSTRAP: '@openclawdsolana/plugin-bootstrap',
    OLLAMA: '@openclawdsolana/plugin-ollama',
    ANTHROPIC: '@openclawdsolana/plugin-anthropic',
    OPENAI: '@openclawdsolana/plugin-openai',
    OPENROUTER: '@openclawdsolana/plugin-openrouter',
    GOOGLE_GENAI: '@openclawdsolana/plugin-google-genai',
    DISCORD: '@openclawdsolana/plugin-discord',
    TWITTER: '@openclawdsolana/plugin-twitter',
    TELEGRAM: '@openclawdsolana/plugin-telegram',
  };
