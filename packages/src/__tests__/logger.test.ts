...
import { createLogger, logger, openclawdLogger } from '../logger';
...
describe('Logger', () => {
  ...
  describe('Logger Creation', () => {
    ...
    it('should export openclawdLogger as alias for backward compatibility', () => {
      expect(openclawdLogger).toBeDefined();
      expect(openclawdLogger).toBe(logger);
    });
