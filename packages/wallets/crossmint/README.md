...
# Crossmint Utilities for OpenClawd
...
## Installation
```
npm install @openclawdsolana/wallet-crossmint
yarn add @openclawdsolana/wallet-crossmint
pnpm add @openclawdsolana/wallet-crossmint
```
...
import { crossmint } from "@openclawdsolana/crossmint";
