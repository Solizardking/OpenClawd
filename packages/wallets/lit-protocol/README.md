...
<!-- omit in toc -->
# Lit Protocol Wallets for OpenClawd

A OpenClawd wallet client implementation for Lit Protocol, supporting both EVM and Solana chains.
...
```bash
npm install @openclawdsolana/wallet-lit
yarn add @openclawdsolana/wallet-lit
pnpm add @openclawdsolana/wallet-lit
```
...
import { 
    ...
    generateWrappedKey,
    lit 
} from "@openclawdsolana/wallet-lit";
