import type { EVMReadRequest, EVMReadResult, EVMTransaction, EVMTypedData } from "@openclawdsolana/wallet-evm";
...
import { type EvmChain, NativeCurrency, type Signature } from "@openclawdsolana/core";
