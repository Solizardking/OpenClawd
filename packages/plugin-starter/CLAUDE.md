# OpenClawd Plugin Development Guide for Claude

> **Optimized for Claude LLM** - Complete reference for building OpenClawd plugins

## 📋 Project Overview

| Property            | Value                 |
| ------------------- | --------------------- |
| **Project Type**    | OpenClawd Plugin        |
| **Package Manager** | `bun` (REQUIRED)      |
| **Language**        | TypeScript (Required) |
| **Testing**         | Bun test              |
| **Runtime**         | OpenClawd Agent Runtime |

## 🏗️ Plugin Architecture

OpenClawd plugins follow a **component-based architecture** with four main types:
...
```typescript
import { Action, ActionResult } from '@openclawdsolana/core';
...
```typescript
// src/index.ts
import { Plugin } from '@openclawdsolana/core';
...
export const plugin: Plugin = {
  name: 'example-plugin',
  description: 'Demonstrates OpenClawd plugin patterns',
...
```json
{
  "name": "@your-org/openclawd-plugin-example",
  "version": "1.0.0",
  "description": "OpenClawd plugin for example functionality",
  "type": "module",
  "main": "dist/index.js",
  ...
  "keywords": ["openclawd", "plugin", "ai-agent"]
}
```
...
**🎉 Ready to build your OpenClawd plugin!** Start with the dev mode and iterate based on real testing.
