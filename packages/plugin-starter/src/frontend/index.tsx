...
// Define the interface for the OPENCLAWD_CONFIG
...
function ExampleRoute() {
  interface WindowWithOpenClawdConfig extends Window {
    OPENCLAWD_CONFIG?: OpenClawdConfig;
  }
  const config = (window as WindowWithOpenClawdConfig).OPENCLAWD_CONFIG;
