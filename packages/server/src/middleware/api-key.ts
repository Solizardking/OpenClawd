 ...
 * Only active if OPENCLAWD_SERVER_AUTH_TOKEN is configured.
 *
...
export function apiKeyAuthMiddleware(
  ...
  const apiKeyConfigured = !!process.env.OPENCLAWD_SERVER_AUTH_TOKEN;
  ...
  if (!apiKey || apiKey !== process.env.OPENCLAWD_SERVER_AUTH_TOKEN) {
