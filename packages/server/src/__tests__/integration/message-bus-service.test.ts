...
import { EventType, type UUID, stringToUuid } from '@openclawdsolana/core';
...
describe('MessageBusService Integration Tests', () => {
  ...
  describe('Message Handling', () => {
    it('should handle new messages from the bus', async () => {
      ...
      // Track if message passes all checks (before OpenClawd.handleMessage which may have DB issues)
