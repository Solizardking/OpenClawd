...
import type { IAgentRuntime, OpenClawd } from '@openclawdsolana/core';
import { EventType, SOCKET_MESSAGE_TYPE, ChannelType } from '@openclawdsolana/core';
import type { AgentServer } from '../../../index';
import internalMessageBus from '../../../services/message-bus';

// Mock types for testing
type MockOpenClawd = Pick<OpenClawd, 'getAgent' | 'getAgents'>;
...
describe('SocketIORouter', () => {
  ...
  let mockOpenClawd: MockOpenClawd;
  ...
  beforeEach(() => {
    ...
    // Create mock OpenClawd instance
    mockOpenClawd = {
    ...
    // Create router instance with OpenClawd and AgentServer
    router = new SocketIORouter(mockOpenClawd as any, mockServerInstance as any);
  });
  ...
  describe('setupListeners', () => {
    ...
    it('should handle new connections', () => {
      ...
      expect(mockSocket.emit).toHaveBeenCalledWith('connection_established', {
        message: 'Connected to OpenClawd Socket.IO server',
        socketId: 'socket-123',
      });
    });
  });
