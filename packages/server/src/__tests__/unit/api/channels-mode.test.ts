...
import type { UUID, OpenClawd } from '@openclawdsolana/core';
...
describe('Channels API - Transport Parameter', () => {
  ...
  beforeEach(() => {
    ...
    const router = createChannelsRouter(mockOpenClawd, mockServerInstance);
