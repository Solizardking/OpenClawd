...
// Mock OpenClawd interface for testing
type MockOpenClawd = Pick<OpenClawd, 'getAgent'>;
...
describe('Middleware Functions', () => {
  ...
  describe('agentExistsMiddleware', () => {
    it('should call next when agent exists', () => {
      ...
      // Create mock OpenClawd with getAgent method
      const mockOpenClawd: MockOpenClawd = {
      ...
      const middleware = agentExistsMiddleware(mockOpenClawd as Partial<OpenClawd> as OpenClawd);
