...
const TEST_CHARACTER_URL =
  'https://raw.githubusercontent.com/OpenClawd/openclawd/refs/heads/develop/packages/cli/tests/test-characters/shaw.json';

const TEST_MULTI_CHARACTER_URL =
  'https://raw.githubusercontent.com/OpenClawd/openclawd/refs/heads/develop/packages/cli/tests/test-characters/multi-chars.json';
