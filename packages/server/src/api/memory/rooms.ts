import type { OpenClawd, UUID } from '@openclawdsolana/core';
import { validateUuid, logger, createUniqueUuid, ChannelType } from '@openclawdsolana/core';
 ...
 */
export function createRoomManagementRouter(OpenClawd: OpenClawd): express.Router {
