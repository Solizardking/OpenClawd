import type { OpenClawd, UUID, Memory, MemoryMetadata } from '@openclawdsolana/core';
import { MemoryType, createUniqueUuid } from '@openclawdsolana/core';
import { validateUuid, logger } from '@openclawdsolana/core';
 ...
 */
export function createAgentMemoryRouter(OpenClawd: OpenClawd): express.Router {
