 ...
 */
export function createSessionsRouter(OpenClawd: OpenClawd, serverInstance: AgentServer): SessionRouter {
  ...
  router.post(
    ...
    asyncHandler(async (req: express.Request, res: express.Response) => {
      ...
      const agent = OpenClawd.getAgent(body.agentId as UUID);
      if (!agent) {
  ...
  router.post(
    ...
    asyncHandler(async (req: express.Request, res: express.Response) => {
      ...
      // Build Memory object for OpenClawd.handleMessage
      const messageMemory = {
  ...
  router.patch(
    ...
    asyncHandler(async (req: express.Request, res: express.Response) => {
      ...
      const agent = OpenClawd.getAgent(session.agentId);
