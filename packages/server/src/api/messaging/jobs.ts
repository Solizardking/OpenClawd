 ...
 */
import { logger, validateUuid, type UUID, type OpenClawd, ChannelType } from '@openclawdsolana/core';
 ...
 */
export function createJobsRouter(OpenClawd: OpenClawd, serverInstance: AgentServer): JobsRouter {
