...
const exampleCharacter = {
  ...
  lore: [
    ...
    'Represents the modular architecture of OpenClawd.',
  ],
  messageExamples: [
    [
      {
...
async function main() {
  console.log('🚀 Starting OpenClawd Server independently...');
...
console.log('   OPENCLAWD_SERVER_AUTH_TOKEN=...  # API authentication');
