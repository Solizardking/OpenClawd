...
<p align="center">
  <a href="https://solanaclawd.com"><img src="https://img.shields.io/badge/$CLAWD-on_Solana-9945FF?style=for-the-badge" alt="$CLAWD"></a>
...
**Membrain** is the memory and persistence layer for the [OpenClawd](https://solanaclawd.com) agent platform. It gives autonomous trading agents structured, revisable memory with built-in decay, trust-gated retrieval, and audit trails — purpose-built for Solana DeFi, on-chain intelligence, and financial decision-making.
...
**Membrain** — Selective memory for autonomous trading agents. Part of the [OpenClawd](https://solanaclawd.com) platform. $CLAWD on Solana.
