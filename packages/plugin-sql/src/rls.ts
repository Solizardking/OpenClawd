import { logger, validateUuid, type IDatabaseAdapter } from '@openclawdsolana/core';
 ...
 *    - Isolates data between different OpenClawd server instances
 ...
 *
 * **Security Model:**
 * - Server RLS: Isolation between different OpenClawd instances (environments/deployments)
...
export async function setServerContext(adapter: IDatabaseAdapter, serverId: string): Promise<void> {
  // Validate UUID format using @openclawdsolana/core utility
