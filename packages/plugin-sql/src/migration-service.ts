import { logger, type Plugin, type IDatabaseAdapter } from '@openclawdsolana/core';
      ...
      try {
        ...
        if (errorMessage.includes('Destructive migration blocked')) {
          ...
          logger.error(
            ...
            'Migration blocked - destructive changes detected. Set OPENCLAWD_ALLOW_DESTRUCTIVE_MIGRATIONS=true or use force option'
          );
        } else {
          // Unexpected error
