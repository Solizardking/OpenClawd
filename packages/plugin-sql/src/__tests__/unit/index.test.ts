import type { IAgentRuntime } from '@openclawdsolana/core';
...
describe('SQL Plugin', () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = fs.mkdtempSync(path.join(os.tmpdir(), 'openclawd-plugin-sql-test-'));
  ...
  describe('Plugin Structure', () => {
    it('should have correct plugin metadata', () => {
      expect(plugin.name).toBe('@openclawdsolana/plugin-sql');
