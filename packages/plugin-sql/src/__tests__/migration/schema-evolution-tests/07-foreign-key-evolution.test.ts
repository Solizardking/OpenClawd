...
describe('Schema Evolution Test: Foreign Key Evolution', () => {
  ...
  it('should handle adding foreign keys with orphaned records', async () => {
    ...
    await migrator.migrate('@openclawdsolana/fk-test-v1', schemaV1);
    ...
    const check = await migrator.checkMigration('@openclawdsolana/fk-test-v1', schemaV2);
    ...
    try {
      await migrator.migrate('@openclawdsolana/fk-test-v1', schemaV2);
    } catch (error) {
  ...
  it('should handle changing CASCADE behavior', async () => {
    ...
    await migrator.migrate('@openclawdsolana/cascade-test-v1', schemaV1);
    ...
    const check = await migrator.checkMigration('@openclawdsolana/cascade-test-v1', schemaV2);
    ...
    await migrator.migrate('@openclawdsolana/cascade-test-v1', schemaV2);
  ...
  it('should handle complex foreign key scenarios with composite keys', async () => {
    ...
    await migrator.migrate('@openclawdsolana/complex-fk-v1', schemaV1);
    ...
    await migrator.migrate('@openclawdsolana/complex-fk-v1', schemaV2);
  ...
  it('should handle foreign keys with manager references', async () => {
    ...
    await migrator.migrate('@openclawdsolana/circular-fk-v1', schemaV1);
    ...
    await migrator.migrate('@openclawdsolana/circular-fk-v1', schemaV2);
