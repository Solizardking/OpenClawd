...
describe('Schema Evolution Test: Constraint Modifications', () => {
  ...
  beforeEach(async () => {
    ...
    process.env.OPENCLAWD_ALLOW_DESTRUCTIVE_MIGRATIONS = 'true';
  });
  ...
  it('should handle adding NOT NULL to columns with NULL values', async () => {
    ...
    await migrator.migrate('@openclawdsolana/not-null-test-v1', schemaV1);
    ...
    const check = await migrator.checkMigration('@openclawdsolana/not-null-test-v1', schemaV2);
    ...
    try {
      await migrator.migrate('@openclawdsolana/not-null-test-v1', schemaV2);
    } catch (error) {
  ...
  it('should handle adding UNIQUE constraints with duplicate values', async () => {
    ...
    await migrator.migrate('@openclawdsolana/unique-test-v1', schemaV1);
    ...
    const check = await migrator.checkMigration('@openclawdsolana/unique-test-v1', schemaV2);
    ...
    let migrationError: Error | null = null;
    try {
      await migrator.migrate('@openclawdsolana/unique-test-v1', schemaV2);
    } catch (error) {
      migrationError = error as Error;
    }
  ...
  it('should handle adding CHECK constraints with violating data', async () => {
    ...
    await migrator.migrate('@openclawdsolana/check-test-v1', schemaV1);
    ...
    const check2 = await migrator.checkMigration('@openclawdsolana/check-test-v1', schemaV2);
    ...
    let migrationError: Error | null = null;
    try {
      await migrator.migrate('@openclawdsolana/check-test-v1', schemaV2);
    } catch (error) {
      migrationError = error as Error;
    }
  ...
  it('should handle multiple constraint additions in single migration', async () => {
    ...
    await migrator.migrate('@openclawdsolana/multi-constraints-v1', schemaV1);
    ...
    const check2 = await migrator.checkMigration('@openclawdsolana/multi-constraints-v1', schemaV2);
    ...
    await migrator.migrate('@openclawdsolana/multi-constraints-v1', schemaV2);
