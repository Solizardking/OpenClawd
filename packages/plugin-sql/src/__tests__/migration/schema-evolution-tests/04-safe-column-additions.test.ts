...
describe('Schema Evolution Test: Safe Column Additions', () => {
  ...
  it('should add nullable columns without warnings', async () => {
    ...
    await migrator.migrate('@openclawdsolana/safe-additions-v1', schemaV1);
    ...
    const check = await migrator.checkMigration('@openclawdsolana/safe-additions-v1', schemaV2);
    ...
    await migrator.migrate('@openclawdsolana/safe-additions-v1', schemaV2);
  ...
  it('should add NOT NULL columns with defaults without warnings', async () => {
    ...
    console.log('📦 Creating initial schema...');
    await migrator.migrate('@openclawdsolana/defaults-test-v1', schemaV1);
    ...
    // Check migration - should have no warnings
    console.log('\n🔍 Checking for data loss warnings...');
    const check = await migrator.checkMigration('@openclawdsolana/defaults-test-v1', schemaV2);
    ...
    await migrator.migrate('@openclawdsolana/defaults-test-v1', schemaV2);
    console.log('  ✅ Migration completed successfully');
  ...
  it('should handle adding columns with valid DEFAULT expressions', async () => {
    ...
    console.log('📦 Creating initial schema...');
    await migrator.migrate('@openclawdsolana/complex-columns-v1', schemaV1);
    ...
    const check = await migrator.checkMigration('@openclawdsolana/complex-columns-v1', schemaV2);
    ...
    await migrator.migrate('@openclawdsolana/complex-columns-v1', schemaV2);
  ...
  it('should add multiple columns in single migration', async () => {
    ...
    await migrator.migrate('@openclawdsolana/multi-column-v1', schemaV1);
    ...
    const check = await migrator.checkMigration('@openclawdsolana/multi-column-v1', schemaV2);
    ...
    await migrator.migrate('@openclawdsolana/multi-column-v1', schemaV2);
