...
describe('Schema Evolution Test: Index Evolution', () => {
  ...
  it('should add various types of indexes without warnings', async () => {
    ...
    await migrator.migrate('@openclawdsolana/index-test-v1', schemaV1);
    ...
    const check = await migrator.checkMigration('@openclawdsolana/index-test-v1', schemaV2);
    ...
    console.log('\n📦 Adding indexes...');
    await migrator.migrate('@openclawdsolana/index-test-v1', schemaV2);
  ...
  it('should drop and recreate indexes without data loss', async () => {
    ...
    await migrator.migrate('@openclawdsolana/index-change-v1', schemaV1);
    ...
    const check = await migrator.checkMigration('@openclawdsolana/index-change-v1', schemaV2);
    ...
    console.log('\n📦 Modifying indexes...');
    await migrator.migrate('@openclawdsolana/index-change-v1', schemaV2);
  ...
  it('should handle complex index scenarios', async () => {
    ...
    await migrator.migrate('@openclawdsolana/complex-index-v1', schemaV1);
    ...
    const check = await migrator.checkMigration('@openclawdsolana/complex-index-v1', schemaV2);
    ...
    await migrator.migrate('@openclawdsolana/complex-index-v1', schemaV2);
  ...
  it('should handle index name conflicts gracefully', async () => {
    ...
    await migrator.migrate('@openclawdsolana/conflict-test-v1', schemaV1);
    ...
    await migrator.migrate('@openclawdsolana/conflict-test-v1', schemaV2);
