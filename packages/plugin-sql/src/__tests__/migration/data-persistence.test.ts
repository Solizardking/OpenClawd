...
describe('Data Persistence Through Migrations', () => {
  ...
  describe('Critical Data Persistence Scenarios', () => {
    it('should preserve ALL data through column additions', async () => {
      ...
      const status = await migrator.getStatus('@openclawdsolana/plugin-sql');
    ...
    it('should correctly track migration history through multiple changes', async () => {
      ...
      await migrator.migrate('@openclawdsolana/plugin-sql', { orders: ordersV1 }, { verbose: false });
      ...
      await migrator.migrate('@openclawdsolana/plugin-sql', { orders: ordersV2 }, { verbose: false });
      ...
      await migrator.migrate('@openclawdsolana/plugin-sql', { orders: ordersV3 }, { verbose: false });
