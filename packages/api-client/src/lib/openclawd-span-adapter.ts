...
import type { RunDetail, RunEvent, RunSummary } from '@openclawdsolana/api-client';

/**
 * Adapter to convert OpenClawd RunDetail data to Agent Prism TraceSpan format
 */
export class OpenClawdSpanAdapter {
  /**
   * Convert OpenClawd RunDetail to Agent Prism TraceSpans with hierarchical structure
   */
...
export const openclawdSpanAdapter = new OpenClawdSpanAdapter();
