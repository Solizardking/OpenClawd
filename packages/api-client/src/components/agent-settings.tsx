...
import { AgentStatus } from '@openclawdsolana/core';
      ...
      try {
        ...
        if (Object.keys(changedFields).length === 0) {
          ...
          if (secrets && Object.keys(secrets).length > 0) {
            ...
            await openclawdClient.agents.updateAgent(agentId, forceUpdate as Partial<Agent>);
        ...
        await openclawdClient.agents.updateAgent(agentId, partialUpdate as Agent);
