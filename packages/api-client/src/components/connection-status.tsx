  ...
  useEffect(() => {
    if (
      ...
      toast({
        ...
        description: (
          <div className="flex items-center gap-2">
            ...
            <span>Successfully reconnected to the OpenClawd server.</span>
          </div>
        ),
      });
      ...
      toast({
        ...
        description: 'Attempting to reconnect to the OpenClawd server...',
        variant: 'destructive',
      });
    }
        ...
        {showingError && (
          <TooltipContent side="top" align="center" className="max-w-xs">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-xs">Please ensure the OpenClawd server is running and accessible.</p>
              {!isUnauthorized && (
