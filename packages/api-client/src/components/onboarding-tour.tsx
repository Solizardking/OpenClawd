  ...
  const homeSteps = [
    {
      target: '.sidebar-logo',
      content:
        'Welcome to OpenClawd! This is your gateway to creating and managing intelligent AI agents.',
      disableBeacon: true,
      title: 'Welcome to OpenClawd',
    },
    {
    ...
    },
    {
      ...
      content: 'This indicator shows your connection status to the OpenClawd server.',
