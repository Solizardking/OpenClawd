import type { Agent } from '@openclawdsolana/core';
...
export const agentTemplates: AgentTemplate[] = [
  {
    ...
    template: {
      ...
      topics: [],
      adjectives: [],
      plugins: ['@openclawdsolana/plugin-sql', '@openclawdsolana/plugin-openai', '@openclawdsolana/plugin-bootstrap'],
      settings: { secrets: {} },
    },
  },
  ...
  },
  {
    ...
    template: {
      ...
      plugins: [
        ...
        '@openclawdsolana/plugin-openai',
        '@openclawdsolana/plugin-bootstrap',
        '@openclawdsolana/plugin-instagram',
      ],
      style: {
        all: [
