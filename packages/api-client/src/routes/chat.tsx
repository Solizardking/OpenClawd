...
import { ChannelType, AgentStatus as CoreAgentStatusEnum, type UUID } from '@openclawdsolana/core';
...
function AgentRouteContent() {
  ...
  const { agent, isLoading, isStarting, start } = useOpenClawdAgent(agentId);
