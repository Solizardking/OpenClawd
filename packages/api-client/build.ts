#!/usr/bin/env bun
/**
 * Build script for @openclawdsolana/api-client using standardized build utilities
 */
...
const run = createBuildRunner({
  packageName: '@openclawdsolana/api-client',
  buildOptions: {
    entrypoints: ['src/index.ts'],
    outdir: 'dist',
    target: 'node',
    format: 'esm',
    external: ['@openclawdsolana/core', 'fs', 'path'],
    sourcemap: true,
    minify: false,
    generateDts: true,
  },
