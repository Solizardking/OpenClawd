...
/**
 * OpenClawd custom ESLint plugin
 */
const openclawdPlugin = {
  meta: { name: '@openclawdsolana/eslint-plugin', version: '1.0.0' },
  rules: {
...
/**
 * Base ESLint configuration for OpenClawd packages
...
export const baseConfig = [
  js.configs.recommended,
  {
    ...
    plugins: {
      ...
      '@openclawd': openclawdPlugin,
    },
    rules: {
      // OpenClawd custom rules - structured logging
      '@openclawdsolana/structured-logging': 'warn',
...
export const testOverrides = {
  ...
  rules: {
    '@openclawdsolana/structured-logging': 'off', // Tests can use any log format
    '@typescript-eslint/no-explicit-any': 'off',
