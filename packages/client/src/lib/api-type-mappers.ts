import {
  ...
  Memory as ApiMemory,
} from '@openclawdsolana/api-client';
import { Agent, AgentStatus, UUID, ChannelType, Memory, Media } from '@openclawdsolana/core';
import type {
...
// ApiAgent is now the core Agent type (re-exported from @openclawdsolana/api-client)
