...
const MAIN_PANEL_WIDTH_KEY = 'openclawd-main-panel-width';
const SIDEBAR_PANEL_WIDTH_KEY = 'openclawd-sidebar-panel-width';
const FLOATING_THRESHOLD_KEY = 'openclawd-floating-threshold';
