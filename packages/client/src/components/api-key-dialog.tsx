...
const getLocalStorageApiKey = () =>
  typeof window === 'undefined' ? 'openclawd-api-key' : `openclawd-api-key-${window.location.origin}`;
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Please enter the API key required to connect to the OpenClawd server. This key will be
