import type { UUID, Content, ChannelType as CoreChannelType } from '@openclawdsolana/core';
import type { MessageServerMetadata, ChannelMetadata, MessageMetadata } from '@openclawdsolana/api-client';
...
export interface MessageChannel {
  ...
  name: string;
  type: CoreChannelType; // Using the enum from @openclawdsolana/core
  sourceType?: string;
  sourceId?: string;
  topic?: string;
