#!/usr/bin/env bun
/**
 * Dual build script for @openclawdsolana/service-interfaces - generates both Node.js and browser builds
 */
...
const sharedConfig = {
  packageName: '@openclawdsolana/service-interfaces',
  sourcemap: true,
  minify: false,
  generateDts: true,
};
...
async function buildAll() {
  console.log('🚀 Starting dual build process for @openclawdsolana/service-interfaces');
