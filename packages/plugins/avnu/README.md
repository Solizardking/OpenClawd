...
# Avnu OpenClawd Plugin

Get quotes and swap on [Avnu](https://app.avnu.fi)

## Installation
```bash
npm install @openclawdsolana/plugin-avnu
yarn add @openclawdsolana/plugin-avnu
pnpm add @openclawdsolana/plugin-avnu
```

## Usage
```typescript
import { avnu } from '@openclawdsolana/plugin-avnu';
