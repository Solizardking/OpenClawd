...
# OrderlyNetwork OpenClawd Plugin
...
```bash
npm install @openclawdsolana/plugin-orderly-network
yarn add @openclawdsolana/plugin-orderly-network
pnpm add @openclawdsolana/plugin-orderly-network
```

## Usage

```typescript
import { orderlynetwork } from '@openclawdsolana/plugin-orderly-network';
