...
import { type Chain, PluginBase, createTool } from "@openclawdsolana/core";
import type { z } from "zod";

import { EVMWalletClient } from "@openclawdsolana/wallet-evm";
import { SolanaWalletClient } from "@openclawdsolana/wallet-solana";
...
export class CrossmintHeadlessCheckoutPlugin extends PluginBase {
    ...
    constructor(
        ...
        this.crossmintApiClient = new CrossmintApiClient(validatedCrossmint, {
            internalConfig: {
                sdkMetadata: {
                    name: "@openclawdsolana/plugin-crossmint-headless-checkout",
