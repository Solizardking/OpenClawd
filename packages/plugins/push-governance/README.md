...
# PushGovernance OpenClawd Plugin
...
## Installation
```bash
npm install @openclawdsolana/plugin-push-governance
yarn add @openclawdsolana/plugin-push-governance
pnpm add @openclawdsolana/plugin-push-governance
```

## Usage
```typescript
import { pushgovernance } from '@openclawdsolana/plugin-push-governance';
