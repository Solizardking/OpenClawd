...
# Curves OpenClawd Plugin

## Installation
```
npm install @openclawdsolana/plugin-curves
yarn add @openclawdsolana/plugin-curves
pnpm add @openclawdsolana/plugin-curves
```
...
import { curves } from "@openclawdsolana/plugin-curves";
...
## Tools
When using with OpenClawd, the following tools are available:
