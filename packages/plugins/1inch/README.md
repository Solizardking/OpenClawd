...
# 1inch OpenClawd Plugin

Get balances for different tokens for a wallet using the [1inch API](https://1inch.io/page-api/).

## Installation
```bash
npm install @openclawdsolana/plugin-1inch
yarn add @openclawdsolana/plugin-1inch
pnpm add @openclawdsolana/plugin-1inch
```

## Usage
```typescript
import { oneInch } from '@openclawdsolana/plugin-1inch';
