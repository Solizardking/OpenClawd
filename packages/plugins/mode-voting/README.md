...
[Mode](https://mode.network/) governance plugin for OpenClawd. Allows you to interact with Mode's governance system including staking MODE and BPT tokens.

## Installation
```bash
npm install @openclawdsolana/plugin-mode-voting
yarn add @openclawdsolana/plugin-mode-voting
pnpm add @openclawdsolana/plugin-mode-voting
```

## Usage

```typescript
import { modeVoting } from "@openclawdsolana/plugin-mode-voting";
