...
type AgentEntry = NonNullable<NonNullable<OpenClawdConfig["agents"]>["list"]>[number];

function listAgents(cfg: OpenClawdConfig): AgentEntry[] {
...
function resolveAgentEntry(cfg: OpenClawdConfig, agentId: string): AgentEntry | undefined {
  const id = normalizeAgentId(agentId);
  return listAgents(cfg).find((entry) => normalizeAgentId(entry.id) === id);
}

export function resolveIdentityName(cfg: OpenClawdConfig, agentId: string): string | undefined {
