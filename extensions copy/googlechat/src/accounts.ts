...
export function listGoogleChatAccountIds(cfg: OpenClawdConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: OpenClawdConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: OpenClawdConfig): ResolvedGoogleChatAccount[] {
