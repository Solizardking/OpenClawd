...
const FEATURES = [
  ...
  { icon: '🔒', title: 'Staking', desc: 'Metaplex Core agent locks', link: '/staking' },
  { icon: '⬡', title: 'Metaplex', desc: '014 Agent Registry', link: '/setup/metaplex' },
  { icon: '📰', title: 'News', desc: 'Latest protocol updates', link: '/news' },
  { icon: 'ⓘ', title: 'About', desc: 'Runtime and agent economy', link: '/about' },
