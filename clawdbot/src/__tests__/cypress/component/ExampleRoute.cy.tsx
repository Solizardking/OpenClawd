...
const ExampleRoute = () => {
  const [config, setConfig] = React.useState(window.OPENCLAWD_CONFIG);
...
describe('ExampleRoute Component Tests', () => {
  describe('Component Rendering', () => {
    ...
    it('should show error when agent ID is missing', () => {
      ...
      cy.window().then((win) => {
        win.OPENCLAWD_CONFIG = undefined;
      });
  ...
  describe('Configuration Handling', () => {
    it('should handle OPENCLAWD_CONFIG changes', () => {
...
/**
 * TESTING PATTERNS FOR FRONTEND COMPONENTS IN OPENCLAWD
 *
 ...
 *    - Always test with and without OPENCLAWD_CONFIG
 ...
 *     cy.setOpenClawdConfig({ agentId: 'test-id', apiBase: 'http://localhost:3000' });
 *   });
 *
 *   describe('Rendering', () => {
